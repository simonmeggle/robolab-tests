...
!! ACTION: 
- Fix the errors and run the test with the debugger. 
- Inspect the Robot Output pane
- Inspect the test results in the test pane  
- set brekpoints with F9  

*** Test Cases ***
Hello World
 Log To Console    This is wrong (only 1 space)
