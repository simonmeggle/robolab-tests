# With these changes, we get always a result for CMK version 1 and another one for 
# version 2. 


# --------------------
# YOUR TASK: 
# - Run this suite again with the parameters and open the log.html. 
#   You should see now three test cases.
